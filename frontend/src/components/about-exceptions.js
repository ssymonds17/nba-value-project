 ...
 render() {
  return (
   <section id="exceptions">
    ...
    <br />
    <p>
     <a href="https://www.basketball-reference.com/" target="_blank" rel="noopener noreferrer">Basketball-Reference’s</a> VORP and BPM metrics cover a large portion of the NBA’s history, however it does not encapsulate the entirety. Therefore there are some circumstances where alternative metrics had to be used. The following list outlines which metrics were used for which time periods.
    </p>
    ...
    <p>
     To a certain degree it is clear that when the ABA began the talent gap was large, but over the next several years this gap continued to shrink. Ben Taylor points to research done on the matter during his write-up on <a href="https://backpicks.com/2018/01/01/backpicks-goat-16-julius-erving/" target="_blank" rel="noopener noreferrer">Julius Erving</a> and I used the chart there as a loose guide on how to deal with the ABA problem. For each ABA season, player’s seasonal scores were given a percentage reduction to reflect the level of play in comparison to the NBA. In some ways I felt that the reductions may have been too harsh, however if they were not set at the levels I chose, Julius Erving would have ended up as a top 3-5 player of all time and Artis Gilmore very well may have cracked the top 20. As interesting as these findings may have been, they are far too removed from the general consensus for me to be comfortable.
    </p>
    <p>
