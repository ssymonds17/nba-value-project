  ...
  render() {
    ...
    return (
      <div>
        ...
        <div>
          <Link to={`/seasons/playoffs/${season[0].league}/${season[0].year - 1}`}><button style={this.setPreviousSeasonButtonStyle()}>{`<<`} {season[0].year - 1} Season</button></Link>
          <Link to={`/seasons/playoffs/${season[0].league}/${season[0].year + 1}`}><button style={this.setNextSeasonButtonStyle()}>{season[0].year + 1} Season {`>>`}</button></Link>
        </div>
