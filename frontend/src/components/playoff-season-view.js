  ...
  render() {
    ...
    return (
      <div>
        ...
        <div>
          <Link to={`/seasons/playoffs/${season[0].league}/${season[0].year - 1}`}><button>Previous Season</button></Link>
          <Link to={`/seasons/playoffs/${season[0].league}/${season[0].year + 1}`}><button>Next Season</button></Link>
        </div>
        <table>
          <thead>
            <tr>
