        ...
        <div className="team-header-container">
          ...
          <div className="team-btn-container">
            <div className="season-change-btn-container">
              <Link to={`/teams/${team[0].team_abbreviation}/${team[0].year - 1}`}><Button className="custom-btn" style={this.setPreviousSeasonButtonStyle()}>{`<<`} {team[0].year - 1} Season</Button></Link>
              <Link to={`/teams/${team[0].team_abbreviation}/${team[0].year + 1}`}><Button className="custom-btn" style={this.setNextSeasonButtonStyle()}>{team[0].year + 1} Season {`>>`}</Button></Link>
            </div>
            <div className="index-btn-container">
              <Link to={`/teams/${team[0].franchise_code}`}><Button className="custom-btn btn-lg">{team[0].team_full_name} Franchise Index</Button></Link>
            </div>
          </div>
        </div>
            ...
            <tbody>
              {
                team.map(season => (
                  <tr key={season._id}>
                    ...
                    <td className="score-column">{Number((season.regularSeason__score + season.playoff__score)).toFixed(2)}</td>
