 ...
 render() {
  return (
   <section id="methodology">
    ...
    <br />
    <p>
     1. First we find the VORP value for each player and then find the team total. Players with <a href="#">negative VORP</a> values are rounded to 0.
   </p>
    <br />
    ...
    <p>
     3. We can then apply each player’s proportion to their team’s win total to calculate the number of wins that they can be credited with (Season Value), very much like how win-shares works. An adjustment is made on the team's win total which is explained <a href="#">here</a>.
   </p>
    <p>
    ...
    <p>
     4. <a href="#">Seeding Adjustment</a>: Players are given an adjustment to their season value based on the seeding that their team achieves. Players whose team did not make the playoffs receive no adjustment. The higher the seed the greater the boost in value. The 1996 Chicago Bulls were a one seed.
   </p>
    <br />
    <div className="table-container" style={{ height: '100px' }}>
     <Table bordered responsive>
    ...
    <p>
     5. <a href="#">BPM rate statistic adjustment</a>: Players are given a boost based upon their performance per 100 possessions.
   </p>
    <p>
    ...
    <p>
     6. <a href="#">Minute's Adjustment</a>: Players have their season value adjusted depending on how far their minutes per game (MPG) are removed from the league leaders. (The lower MPG the greater the penalty).
   </p>
    ...
    <p>
     7. <a href="#">Year Adjustment</a>: Every player in the league has their season value adjusted based on the strength of the league.
   </p>
    ...
    <p>
     <a href="#">Step A - Playoff Round</a>: The 1996 Chicago Bulls won the NBA title. They are awarded with 90 wins for how far they advanced in the playoffs.
   </p>
    <p>
     <a href="#">Step B - Win Percentage</a>: The 1996 Chicago Bulls had a playoff win percentage of 83.3%. Using this their win total is adjusted to 120 wins.
   </p>
    <p>
    ...
    <p>
     4. <a href="#">Seeding Adjustment</a>: Adjust the playoff value based on the team's seed from the regular season. This adjustment works in reverse to how it is applied in the regular season. Now the lower the seed, the greater the boost in value.
   </p>
    <p>
    ...
    <br />
    <p>
     5. <a href="#">BPM rate statistic adjustment</a>: Adjust the player's playoff value according to their BPM value.
   </p>
    <br />
    <div className="table-container" style={{ height: '100px' }}>
     <Table bordered responsive>
    ...
    <p>
     6. <a href="#">Minute's Adjustment</a>: Adjust the playoff value based upon the player's playing time.
   </p>
    ...
    <p>
     7. <a href="#">Opposition Strength Adjustment</a>: Adjust the playoff value according to the strength of the teams faced throughout the playoffs.
   </p>
    <p>
