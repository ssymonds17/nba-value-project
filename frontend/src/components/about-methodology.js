  ...
  render() {
    return (
      <section id="methodology">
        ...
        <br />
        <p>
          1. First we find the VORP value for each player and then find the team total. Players with <button className="scroll-btn" onClick={this.scrollToNegativeVORP}>negative VORP</button> values are rounded to 0.
        </p>
        <br />
        ...
        <p>
          4. <button className="scroll-btn" onClick={this.scrollToSeeding}>Seeding Adjustment</button>: Players are given an adjustment to their season value based on the seeding that their team achieves. Players whose team did not make the playoffs receive no adjustment. The higher the seed the greater the boost in value. The 1996 Chicago Bulls were a one seed.
        </p>
        <br />
        <div className="table-container" style={{ height: '100px' }}>
          <Table bordered responsive>
        ...
        <p>
          5. <button className="scroll-btn" onClick={this.scrollToBPM}>BPM rate statistic adjustment</button>: Players are given a boost based upon their performance per 100 possessions.
        </p>
        <p>
        ...
        <p>
          6. <button className="scroll-btn" onClick={this.scrollToMinutes}>Minute's Adjustment</button>: Players have their season value adjusted depending on how far their minutes per game (MPG) are removed from the league leaders. (The lower MPG the greater the penalty).
        </p>
        ...
        <p>
          7. <button className="scroll-btn" onClick={this.scrollToYear}>Year Adjustment</button>: Every player in the league has their season value adjusted based on the strength of the league.
        </p>
        ...
        <p>
          <button className="scroll-btn" onClick={this.scrollToWinTotalRounds}>Step A - Playoff Round</button>: The 1996 Chicago Bulls won the NBA title. They are awarded with 90 wins for how far they advanced in the playoffs.
       </p>
        <p>
          <button className="scroll-btn" onClick={this.scrollToWinTotalPercentage}>Step B - Win Percentage</button>: The 1996 Chicago Bulls had a playoff win percentage of 83.3%. Using this their win total is adjusted to 120 wins.
        </p>
        <p>
        ...
        <p>
          4. <button className="scroll-btn" onClick={this.scrollToSeeding}>Seeding Adjustment</button>: Adjust the playoff value based on the team's seed from the regular season. This adjustment works in reverse to how it is applied in the regular season. Now the lower the seed, the greater the boost in value.
   </p>
        <p>
        ...
        <br />
        <p>
          5. <button className="scroll-btn" onClick={this.scrollToBPM}>BPM rate statistic adjustment</button>: Adjust the player's playoff value according to their BPM value.
   </p>
        <br />
        <div className="table-container" style={{ height: '100px' }}>
          <Table bordered responsive>
        ...
        <p>
          6. <button className="scroll-btn" onClick={this.scrollToMinutes}>Minute's Adjustment</button>: Adjust the playoff value based upon the player's playing time.
   </p>
        ...
        <p>
          7. <button className="scroll-btn" onClick={this.scrollToOppositionStrength}>Opposition Strength Adjustment</button>: Adjust the playoff value according to the strength of the teams faced throughout the playoffs.
   </p>
        <p>
