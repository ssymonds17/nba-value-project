...
export class AboutFinalThoughts extends React.Component {
 ...
 render() {
  return (
   <sections id="final-thoughts">
    ...
    <br />
    <p>
     This website was not created to be an authoritative document within the GOAT debate, nor am I stating that everything presented is true and correct. I understand that there is a fair amount within the methodology that is arbitrary and most likely would not hold up to statistical scrutiny.
    </p>
    <p>
