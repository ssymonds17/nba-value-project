    ...
    return (
      <Container className="navbar-container">
        <div>
          <Navbar className="navbar" fixed="top">
            <Link to={`/`}>
              <Button className="nav-btn logo-btn">
                <img
                  src="https://cdn.clipart.email/fbbefc42d83b2977aa6f058688e4a1a3_basketball-silhouette-free-vector-silhouettes_792-800.svg"
                  alt="Basketball Clipart Outline"
                  className="logo"
                />
              </Button>
            </Link>
          ...
          <nav>
            <Link to={`/`}>
              <Button className="home-brand" onClick={this.resetNavbar}>
                NBA Value Reference
              </Button>
            </Link>
            ...
            <div className="nav-links">
              <Link to={`/players`}>
                <Button className="nav-btn-drop" onClick={this.resetNavbar}>
                  Players
                </Button>
              </Link>
              <Link to={`/teams`}>
